...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" >SFAS</a>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      @can('isAdmin')
        <li class="nav-item">
          <a class="nav-link" href="/posts/dashboardA">
      ...
      @can('isAdmin')
        <li class="nav-item">
          <a class="nav-link" href="/posts/indexAd">
            <i class="fa fa-chart-area"></i>
            <span>Application List</span></a>
        </li>
      @endcan
      ...
      @canany(['isUser'])
      <li class="nav-item">
        <a class="nav-link" href="/users/dashboardS">
          <i class="fas fa-fw fa-table"></i>
          <span>Dashboard</span>
        </a>
        ...
        <a class="nav-link" href="/users/indexStud">
          <i class="fas fa-fw fa-table"></i>
          <span>Available SV List</span>
        </a>
      </li>
      @endcanany
      @can(['isSupervisor'])
      <li class="nav-item">
        <a class="nav-link" href="/posts/dashboardSV">
          <i class="fas fa-fw fa-table"></i>
          <span>Dashboard</span></a>
      </li>
      @endcan
      @can(['isSupervisor'])
        <li class="nav-item">
          <a class="nav-link" href="/posts/indexSv">
            <i class="fas fa-fw fa-table"></i>
            <span>Request Lists</span></a>
        </li>
      @endcan
      @can(['isSupervisor'])
      <li class="nav-item">
        <a class="nav-link" href="/posts/supervisee">
          <i class="fas fa-fw fa-table"></i>
          <span>List of Supervisee</span></a>
      </li>
      @endcan
      
      @role('lecturer')
      <li class="nav-item">
        <a class="nav-link" href="/posts/dashboardB">
          <i class="fas fa-fw fa-table"></i>
          <span>Dashboard</span>
        </a>
        <a class="nav-link" href="/users/indexLect">
          <i class="fas fa-fw fa-table"></i>
          <span>List of Supervisor</span>
        </a>
        <a class="nav-link" href="/users/indexLectStud">
          <i class="fas fa-fw fa-table"></i>
          <span>List of Student</span>
        </a>
        <a class="nav-link" href="/posts">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Application Lists</span></a>
      </li>
      @endrole
      </ul>
